...
import ru.example.common.dto.service.exception.ErrorDto;
import ru.example.common.dto.service.exception.ExceptionResponseDto;
...
public class DefaultExceptionController extends AbstractErrorController {
    ...
    public ResponseEntity<ExceptionResponseDto> exceptionHandle(HttpServletRequest request, Locale locale) {
        ...
        String defaultMessage = messageSource.getMessage("api.exception.default.message", null, locale);

        ExceptionResponseDto exceptionBody = new ExceptionResponseDto(
                "UNKNOWN_EXCEPTION",
                defaultMessage,
        ...
        if (exception instanceof MethodArgumentNotValidException) {
            List<FieldError> fieldErrorsList = ((MethodArgumentNotValidException) exception).getBindingResult().getFieldErrors();
